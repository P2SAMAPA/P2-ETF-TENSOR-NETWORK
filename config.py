...
OUTPUT_REPO = "P2SAMAPA/p2-etf-tensor-network-results"
...
# Macro columns (adjust to your dataset)
...
TENSOR_WINDOW = 60   # window for building the tensor
TT_RANK = 5          # rank for TT‑SVD (or PCA reduction)
